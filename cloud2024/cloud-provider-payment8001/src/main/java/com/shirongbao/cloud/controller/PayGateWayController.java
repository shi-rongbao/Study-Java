...
public class PayGateWayController {
    ...
    public ResultData<String> getGatewayFilter(HttpServletRequest request) {
        ...
        while (headers.hasMoreElements()) {
            ...
            if (headName.equalsIgnoreCase("X-Request-srb1")
                    || headName.equalsIgnoreCase("X-Request-srb2")) {
        ...
        String customerName = request.getParameter("password");
