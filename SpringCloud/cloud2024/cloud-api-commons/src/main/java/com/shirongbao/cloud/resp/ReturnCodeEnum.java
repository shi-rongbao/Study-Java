...
public enum ReturnCodeEnum {
     ...
     * 遍历 -> 传统版
     * @param code 状态码
     * @return 返回对应状态码的ReturnCodeEnum 没找到返回null
     */
    ...
    public static ReturnCodeEnum getReturnCodeEnumV2(String code) {
        return Arrays.stream(ReturnCodeEnum.values())  // stream流，拿到这个数组
                .filter(ele -> ele.getCode().equalsIgnoreCase(code))  // 过滤，如果找到了状态码
                .findFirst()  // 返回找到的第一个
